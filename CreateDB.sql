...
CREATE TABLE warships.ships (
  id INT(11) NOT NULL AUTO_INCREMENT,
  name VARCHAR(50) DEFAULT NULL,
  class VARCHAR(255) DEFAULT NULL,
  type VARCHAR(255) DEFAULT NULL,
  launched VARCHAR(255) DEFAULT NULL,
  main_gun_caliber VARCHAR(255) DEFAULT NULL,
  country VARCHAR(255) DEFAULT NULL,
  PRIMARY KEY (id)
)
ENGINE = INNODB;

INSERT INTO warships.ships (name, class, type, launched, main_gun_caliber, country) VALUES
...
('HMS Iron Duke','Iron Duke-class','Battleship',1912,'3.5-inch','United Kingdom'),
('HMS Lion','Lion-class','Battlecruiser',1910,'3.5-inch','United Kingdom'),
('HMS Tiger','Tiger-class','Battlecruiser',1913,'3.5-inch','United Kingdom'),
